...
function addresses_notify_iteminfo($category, $item_id)
{
    ...
    if (empty($xoopsModule) || 'addresses' != $xoopsModule->getVar('dirname')) {
        $moduleHandler = xoops_getHandler('module');

        $module = $moduleHandler->getByDirname('addresses');
    ...
    if ('link' == $category) {
        ...
        $sql = 'SELECT cid,title FROM ' . $xoopsDB->prefix('addresses_links') . ' WHERE lid = ' . $item_id;
        ...
        $item['url'] = XOOPS_URL . '/modules/' . $module->getVar('dirname') . '/visit.php?cid=' . $result_array['cid'] . '&amp;lid=' . $item_id;
