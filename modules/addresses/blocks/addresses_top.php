<?php
// $Id: addresses_top.php,v 1.8 2003/03/28 04:04:51 w4z004 Exp $
//  ------------------------------------------------------------------------ //
...
function b_addresses_top_edit($options)
{
    ...
    $form .= "<input type='text' name='options[]' value='" . $options[1] . "'>&nbsp;" . _MB_MYADRESSES_LINKS . '';

    $form .= '&nbsp;<br>' . _MB_MYADRESSES_CHARS . "&nbsp;<input type='text' name='options[]' value='" . $options[2] . "'>&nbsp;" . _MB_MYADRESSES_LENGTH . '';
