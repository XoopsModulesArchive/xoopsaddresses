...
define('_MD_GENERALSET', 'My addresses General Settings');
define('_MD_ADDMODDELETE', 'Add, Modify, and Delete Categories/Addresses');
define('_MD_LINKSWAITING', 'Addresses Waiting for Validation');
define('_MD_BROKENREPORTS', 'Broken AddressLink Reports');
define('_MD_MODREQUESTS', 'Address Modification Requests');
define('_MD_SUBMITTER', 'Submitter: ');
define('_MD_VISIT', 'Visit');
define('_MD_SHOTMUST', 'Screenshot image must be a valid image file under %s directory (ex. shot.gif). Leave it blank if no image file. This banner image will only be visible within address extended information view.');
...
define('_MD_NOBROKEN', 'No reported broken addresslinks.');
define('_MD_IGNOREDESC', 'Ignore (Ignores the report and only deletes the <b>broken address link report</b>)');
define('_MD_DELETEDESC', 'Delete (Deletes <b>the reported address data</b> and <b>broken address link reports</b> for the address.)');
...
define('_MD_BROKENDELETED', 'Broken addresslink report deleted.');
