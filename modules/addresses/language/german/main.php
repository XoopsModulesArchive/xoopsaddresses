...
define('_MD_THANKSFORINFO', 'Vielen Dank für die Information. Wir werden Ihre Anfrage schnellstmöglich bearbeiten.');
define('_MD_THANKSFORHELP', 'Vielen Dank für Ihre Mithilfe dieses Verzeichnis aktuell zu halten.');
define('_MD_FORSECURITY', 'Aus Sicherheitsgründen werden Ihr Username und Ihre IP-Adresse vorübergehend aufgezeichnet.');
...
define('_MD_REPORTBROKEN', 'Fehlerhafte Link melden');
...
define('_MD_VOTEAPPRE', 'Vielen Dank für Ihre Stimme.');
define('_MD_THANKURATE', 'Vielen Dank, dass Sie sich die Zeit genommen haben hier auf %s abzustimmen.');
define('_MD_VOTEFROMYOU', 'Dank Ihrer Mitarbeit erleichtern Sie es anderen Besuchern interessante Adressen zu finden.');
define('_MD_VOTEONCE', 'Bitte stimmen Sie für die selbe Adresse nur einmal ab.');
define('_MD_RATINGSCALE', 'Die Skala reicht von 1 - 10, wobei 1 schlecht und 10 exzellent ist.');
define('_MD_BEOBJECTIVE', 'Bitte seien Sie objektiv, denn wenn jeder nur mit 1 oder 10 abstimmt ist diese Bewertung nicht sehr aussagekräftig.');
define('_MD_DONOTVOTE', 'Bitte stimmen Sie nicht für Ihre eigene Adresse ab.');
...
define('_MD_RECEIVED', 'Wir haben Ihre Adressinformation erhalten. Vielen Dank!');
define('_MD_WHENAPPROVED', 'Falls Sie ein Mitglied sind, erhalten Sie eine Bestätigungs-Mail nach Freigabe.');
define('_MD_SUBMITONCE', 'Schicken Sie Ihre Adresse nur einmal ein.');
define('_MD_ALLPENDING', 'Alle eingeschickten Adressinformationen müssen noch überprüft werden.');
define('_MD_DONTABUSE', 'Username und IP-Adresse werde aufgezeichnet, deshalb sollten Sie das System nicht missbrauchen.');
define('_MD_TAKESHOT', 'Wir werden die von Ihnen eingeschickte Adresse überprüfen, deshalb kann es einige Zeit dauern bis sie in unsere Datenbank aufgenommen wird.');
...
define('_MD_NOMATCH', 'Keine Ergebnisse zu Ihrer Suchanfrage gefunden');

define('_MD_SUBMIT', 'Abschicken');
define('_MD_CANCEL', 'Abbrechen');

define('_MD_ALREADYREPORTED', 'Sie haben diese Adresse bereits als fehlerhaft gemeldet.');
define('_MD_MUSTREGFIRST', 'Verzeihung, aber Sie sind nicht berechtigt diese Aktion auszuführen.<br>Sie müssen sich zuerst einloggen oder registrieren lassen!');
define('_MD_NORATING', 'Keine Bewertung gewählt.');
define('_MD_CANTVOTEOWN', 'Sie können nicht für eine von Ihnen eingeschickte Adresse abstimmen.<br>Alle Stimmen werden aufgezeichnet und gesichtet.');
define('_MD_VOTEONCE2', 'Bitte stimmen Sie für die gewählte Adresse nur einmal ab.<br>Alle Stimmen werden aufgezeichnet und gesichtet.');
...
define('_MD_WARNING', 'WARNUNG: Sind Sie sicher Sie wollen diese Kategorie und ALLE damit verbundenen Adressen und Kommentare löschen?');
define('_MD_YES', 'Ja');
define('_MD_NO', 'Nein');
define('_MD_NEWCATADDED', 'Neue Kategorie wurde erfolgreich hinzugefügt!');
define('_MD_ERROREXIST', 'FEHLER: Die von Ihnen vorgeschlagene Adresse befindet sich bereits in unserer Datenbank!');
define('_MD_ERRORTITLE', 'FEHLER: Sie müssen Name/Organisation angeben!');
define('_MD_ERRORDESC', 'FEHLER: Sie müssen eine Beschreibung angeben!');
define('_MD_NEWLINKADDED', 'Neue Adresse wurde der Datenbank hinzugefügt.');
define('_MD_YOURLINK', 'Ihre Adresse auf %s');
define('_MD_YOUCANBROWSE', 'Sie können unsere Adressdatenbank auf %s durchsuchen');
define('_MD_HELLO', 'Hallo %s');
define('_MD_WEAPPROVED', 'Wir haben die von Ihnen eingeschickte Adresse in unsere Datenbank aufgenommen.');
define('_MD_THANKSSUBMIT', 'Danke für Ihre Einsendung!');
define('_MD_ISAPPROVED', 'Wir haben die von Ihnen eingeschickte Adresse freigegeben');
//added for adresses//
...
define('_MD_OPENED', 'Öffnungszeiten');
