...
define('_MI_MYADRESSES_GLOBAL_NEWCATEGORY_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn eine neue Adresskategorie erstellt worden ist.');
...
define('_MI_MYADRESSES_GLOBAL_LINKMODIFY_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn eine Adressänderung angefragt worden ist.');
...
define('_MI_MYADRESSES_GLOBAL_LINKBROKEN_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn eine fehlerhafte Adresse gemeldet worden ist.');
...
define('_MI_MYADRESSES_GLOBAL_LINKSUBMIT_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn eine neue Adresse eingeschickt worden ist (noch freizugeben).');
...
define('_MI_MYADRESSES_GLOBAL_NEWLINK_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn neue Adressen veröffentlicht worden sind.');
...
define('_MI_MYADRESSES_CATEGORY_LINKSUBMIT_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn eine neue Adresse (noch freizugeben) für die aktuelle Kategorie eingeschickt worden ist.');
...
define('_MI_MYADRESSES_CATEGORY_NEWLINK_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn eine neue Adresse in der aktuellen Kategorie veröffentlicht worden ist.');
...
define('_MI_MYADRESSES_LINK_APPROVE_NOTIFYDSC', 'Sie erhalten eine Benachrichtigung wenn diese Adresse freigegeben worden ist.');
