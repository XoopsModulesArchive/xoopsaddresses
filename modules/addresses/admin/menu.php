...
$adminmenu[1]['title'] = _MI_MYADRESSES_ADMENU2;
$adminmenu[1]['link'] = 'admin/index.php?op=linksConfigMenu';
$adminmenu[2]['title'] = _MI_MYADRESSES_ADMENU3;
$adminmenu[2]['link'] = 'admin/index.php?op=listNewLinks';
$adminmenu[3]['title'] = _MI_MYADRESSES_ADMENU4;
$adminmenu[3]['link'] = 'admin/index.php?op=listBrokenLinks';
$adminmenu[4]['title'] = _MI_MYADRESSES_ADMENU5;
