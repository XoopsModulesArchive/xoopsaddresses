...
$GLOBALS['xoopsOption']['template_main'] = 'addresses_topten.html';
...
while (list($cid, $ctitle) = $xoopsDB->fetchRow($result)) {
    ...
    $query = 'select lid, cid, title, hits, rating, votes from ' . $xoopsDB->prefix('addresses_links') . " where status>0 and (cid=$cid";
